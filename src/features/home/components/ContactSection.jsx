...
export default function ContactSection() {
  ...
  const { phoneNumber, whatsappNumber, email, mapsEmbedUrl, emailjsServiceId, emailjsPublicKey, emailjsContactTemplateId } = useSiteContactSettings()
  ...
  const handleSubmit = async e => {
    ...
    const templateId = emailjsContactTemplateId
          ...
          <Reveal direction="left" className="lg:col-span-2">
            <div className="space-y-5">
              ...
              <div className="rounded-2xl overflow-hidden border border-white/[0.08] h-48 mt-6">
                <iframe
                  src={mapsEmbedUrl || 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117964.93538086804!2d90.34960495!3d23.7808875!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!5e0!3m2!1sen!2sbd!4v1680000000000!5m2!1sen!2sbd'}
