  ...
  team: [
    {
      ...
      avatar: 'MR',
      bio: '12+ years in architecture and urban design across Bangladesh.',
    },
    {
      name: 'Sumaiya Akter',
      role: 'Head of Interior Design',
      avatar: 'SA',
      bio: 'Award-winning interior designer with a passion for luxury aesthetics.',
    },
    {
      name: 'Karim Hossain',
      role: 'Site & Construction Manager',
      avatar: 'KH',
      bio: 'Civil engineer ensuring every project is built to the highest standard.',
    },
    {
      name: 'Tahmina Islam',
      role: 'Project Coordinator',
      avatar: 'TI',
      bio: 'Your single point of contact — keeping projects on time and on budget.',
    },
  ],
}
